...
user_icon="$(tmux_get '@tmux_power_user_icon' '鬼')"
time_icon="$(tmux_get '@tmux_power_time_icon' '時計')"
date_icon="$(tmux_get '@tmux_power_date_icon' '暦')"
...
# Copy mode highlight
tmux_set mode-style "bg=$TC,fg=$G12"
